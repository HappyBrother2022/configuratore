			...
			<form name="main-form" id="wrapped" method="POST" action="final.php" target="_blank">
				...
				<div id="middle-wizard">
					...
					<div class="step">
						...
						<div class="row" id="selected_t_shirt" style="display: none;">
						</div>
					...
					<div class="step">
						...
						<div class="row" id="selected_pants" style="display: none;">
						</div>
						<div class="load_more" style="text-align: center;">
					...
					<div class="step">
						...
						<div class="row" id="selected_socks" style="display: none;">
						</div>
						<div class="load_more" style="text-align: center;">
							...
							<label style="font-size: 24px;" id="no_socks_label">Nessun prodotto trovato. Per favore <b>completa la configurazione</b> senza includere le Calze</label>
					...
					<div class="step">
						...
						<div class="row" id="selected_ball" style="display: none;">
						</div>
						<div class="load_more" style="text-align: center;">
					...
					<div class="step">
						...
						<div class="row" id="selected_bags" style="display: none;">
						</div>
						<div class="load_more" style="text-align: center;">
					...
					<div class="step">
						...
						<div class="row" id="selected_kits" style="display: none;">
						</div>
						<div class="load_more" style="text-align: center;">
					...
					<div class="step">
						...
						<div class="row" id="selected_sleeve" style="display: none;">
						</div>
						<div class="load_more" style="text-align: center;">
					...
					<div class="step">
						...
						<div class="row" id="selected_sweat" style="display: none;">
						</div>
						<div class="load_more" style="text-align: center;">
					...
					<div class="step">
						...
						<div class="row" id="selected_rainjacket" style="display: none;">
						</div>
						<div class="load_more" style="text-align: center;">
					...
					<div class="step">
						...
						<div class="row" id="selected_jacket" style="display: none;">
						</div>
						<div class="load_more" style="text-align: center;">
					...
					<div class="step">
						...
						<div class="row" id="selected_longpants" style="display: none;">
						</div>
						<div class="load_more" style="text-align: center;">
			...
			<div class="modal-body">
				<form name="example-1" id="wrapped" method="POST" action="mailer_final.php">
					...
					<div class="box_general box-form" style="margin-top: 0;">
						...
						<div class="form-group">
							<input type="number" id="cap_number" name="cap_number" class="required form-control" placeholder="CAP" value="<?php echo (isset($_COOKIE['user']))?(json_decode($_COOKIE['user'],true)['cap']):'' ?>" required>
						</div>
						<div class="form-group">
							<input type="number" id="team_person" name="team_person" class="required form-control" placeholder="Numero Atleti" value="<?php echo (isset($_COOKIE['user']))?(json_decode($_COOKIE['user'],true)['people']):'' ?>" required>
						</div>
