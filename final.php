  ...
  <main>
    <div class="container">
     <div class="question_title">
        <h3 class="preview">Anteprima</h3>
    </div>
    <div class="row justify-content-center" style="background: white; margin-left:0; margin-right:0;">
        ...
        <div class="text-center">
            <h6>Motore Grafico Culture Digitali s.r.l./ GGTEAMWEAR Ver 2.3</h6>
        </div>
</div>
</div>
<!-- /Container -->
